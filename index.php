...
<!-- error class styling for direct user convenience -->
<style type="text/css">
/*    table{margin: 0 auto;background: #DDD;border:10px solid #999;padding:40px;}
    .txtbox{padding: 6px }
*/    .error{
            display: block;
              width: 100%;
...
<!-- fdgfsdgsdfgllllllllllllllllllllllloooooooooolllllllllllllll -->
...
<form action="" method="post" accept-charset="utf-8" class="form" role="form" id="form" name="submit">   <legend>Sign Up</legend>
                    <h4>It's free and always will be.</h4>
                    <!-- <a href="core/database/init.php">check</a> -->
                    <div class="row">
